...
setup(name="muk_scripts",
      version="1.0",
      description="UGent HPC scripts that should be deployed on the muk",
      long_description="""Scripts that run on the muk masters.
- GPFS quota checking and caching
- Queue information caching for the users
- PBS queue monitoring for inactive users

Overlaps with master_scripts, and should be merged back into it ASAP.
""",
      license="LGPL",
      author="HPC UGent",
